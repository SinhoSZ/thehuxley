...
print(f"Candidato A: {x_a:.0f} %" if x_a.is_integer() else f"Candidato A: {x_a:.4f} %")
print(f"Candidato B: {x_b:.0f} %" if x_b.is_integer() else f"Candidato B: {x_b:.4f} %")
print(f"Candidato C: {x_c:.0f} %" if x_c.is_integer() else f"Candidato C: {x_c:.3f} %")
print(f"Votos Nulos: {x_d:.0f} %" if x_d.is_integer() else f"Votos Nulos: {x_d:.5f} %")